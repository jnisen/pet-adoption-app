...
exports.validationUserUpdate = exports.validationSchema = void 0;
...
function validationUserUpdate(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var errors, idUser, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, users.getUserPetsById(idUser)];
                case 1:
                    user = _a.sent();
                    if (errors.array()[0].value === user.user.password) {
                        ...
                        if (errors.array()[0].param === 'password' && (errors.array()[0].value.length === 0 || errors.array()[0].value === undefined)) {
                            ...
                            return [2 /*return*/, res.status(400).send({ errors: errors.array() })];
                    }
                    return [3 /*break*/, 3];
                case 2:
                    next();
...
exports.validationUserUpdate = validationUserUpdate;
