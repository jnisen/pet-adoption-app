...
import { validationPet } from '../middleware/validationSchema'
...
router.post('/addPet', auth, isAdmin, upload.single('image'), schemaPet, validationPet, addPets)
...
//validationPet
router.put('/updatePet/:id', auth, isAdmin, upload.single('image'), schemaPet, validationPet, updatePet)
