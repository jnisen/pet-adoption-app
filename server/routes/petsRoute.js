...
router.post('/addPet', auth_1.auth, isAdmin_1.isAdmin, upload.single('image'), schemaPet_1.schemaPet, validationSchema_1.validationSchema, petController_1.addPets)
...
//validationPet
router.put('/updatePet/:id', auth_1.auth, isAdmin_1.isAdmin, upload.single('image'), schemaPet_1.schemaPet, validationSchema_1.validationSchema, petController_1.updatePet);
